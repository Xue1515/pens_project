...
pen = Pen.new(
  title: 'Hester Dorsey Richardson',
  description: "The fountain pen was available in Europe in the 17th century and is shown by contemporary references.",
  user_id: user.id,
  price: "$ 152",
  category: "Classic")
...
pen = Pen.new(
  ...
  description: "According to Qadi al-Nu'man al-Tamimi (d. 974) in his Kitab al-Majalis wa 'l-musayarat, the Fatimid caliph Al-Mu'izz li-Din Allah in Arab Egypt demanded a pen that would not stain his hands or clothes",
  user_id: user.id,
  price: "$ 254",
  category: "Original")
...
pen = Pen.new(title: 'Stephen Perry ',
  description: "hese were sold worldwide to many who previously could not afford to write, thus encouraging the development of education and literacy.",
  user_id: user.id,
  price: "$ 675",
  category: "Royal")
...
pen = Pen.new(title: 'Fountain pen',
  description: "A great fountain pen and a noteboook",
  user_id: user.id,
  price: "$ 145",
  category: "Classic")
...
pen = Pen.new(title: 'Azel Storrs Lyman ',
  description: "Only after three key inventions were in place that the fountain pen became a widely popular writing instrument. ",
  user_id: user.id,
  price: "$ 965",
  category: "Original")
...
pen = Pen.new(title: '1850',
  description: "This boosted the Birmingham pen trade and by the 1850s, more than half the steel-nib pens manufactured in the world were made in Birmingham.",
  user_id: user.id,
  price: "$ 246",
  category: "Royal")
...
pen = Pen.new(title: 'Duncan MacKinnon,',
  description: "Stylographic pens are now used mostly for drafting and technical drawing but were very popular in the decade beginning in 1875. In the 1880s the era of the mass-produced fountain pen finally began. ",
  user_id: user.id,
  price: "$ 6",
  category: "Classic")
...
pen = Pen.new(title: 'Bloomsburg Pennsylvania',
  description: "At this time, fountain pens were almost all filled by unscrewing a portion of the hollow barrel or holder and inserting the ink by means of an eyedropper – a slow and messy procedure.",
  user_id: user.id,
  price: "$ 965",
  category: "Original")
...
pen = Pen.new(title: 'Conklin',
  description: "The tipping point, however, was the runaway success of Walter A. Sheaffer's lever-filler, introduced in 1912,[20] paralleled by Parker's roughly contemporary button-filler.",
  user_id: user.id,
  price: "$ 145",
  category: "Royal")
...
pen = Pen.new(title: 'Parker Jointless',
  description: "George Safford Parker released the Parker Jointless, named so because its barrel was single-piece to prevent leakage. The section assembly fit into the pen's end like a cork stopper; any leaked ink was kept inside the nib.",
  user_id: user.id,
  price: "$ 352",
  category: "Classic")
...
pen = Pen.new(title: 'Waterman',
  description: "For pens with non-retractable nibs, the adoption of screw-on caps with inner caps that sealed around the nib by bearing against the front of the section effectively solved the leakage problem.",
  user_id: user.id,
  price: "$ 146",
  category: "Original")
...
pen = Pen.new(title: 'Pelikan',
  description: "This was based upon the acquisition of patents for solid-ink fountain pens from the factory of Slavoljub Penkala from Croatia (patented 1907, in mass production since 1911), and the patent of the Hungarian Theodor Kovacs for the modern piston filler by 1925.",
  user_id: user.id,
  price: "$ 965",
  category: "Royal")
...
pen = Pen.new(title: 'Parker Duofold',
  description: "Fountain pens retained their dominance: early ballpoint pens were expensive, were prone to leaks and had irregular inkflow, while the fountain pen continued to benefit from the combination of mass production and craftsmanship.",
  user_id: user.id,
  price: "$ 738",
  category: "Classic")
...
pen = Pen.new(title: 'Parker 51',
  description: "Bíró's patent, and other early patents on ball-point pens often used the term ball-point fountain pen, because at the time the ball-point pen was considered a type of fountain pen; that is, a pen that held ink in an enclosed reservoir.",
  user_id: user.id,
  price: "$ 225",
  category: "Original")
...
pen = Pen.new(title: 'Sheaffer Snorkel',
  description: "Refinements in ballpoint pen production gradually ensured its dominance over the fountain pen for casual use.[37] Although cartridge-filler fountain pens are still in common use in France, Italy, Germany, Austria, India, and the United Kingdom.",
  user_id: user.id,
  price: "$ 356",
  ategory: "Royal")
...
pen = Pen.new(title: 'Faber-Castell',
  description: "Retailers continue to sell fountain pens and inks for casual and calligraphic use. Recently, fountain pens have made a resurgence, with many manufacturers of fountain pens saying sales are climbing.",
  user_id: user.id,
  price: "$ 345",
  category: "Classic")
...
pen = Pen.new(title: 'Lamy 2000',
  description: "The feed allows ink to flow when the pen is being put to paper but ensures ink does not flow when the pen is not in use. The feed makes use of capillary action; this is noticeable when a pen is refilled with a brightly coloured ink.",
  user_id: user.id,
  price: "$ 425",
  category: "Original")
...
pen = Pen.new(title: 'Mathur et al.',
  description: "ollowing the discovery of the platinum group of metals which include ruthenium, osmium, and iridium, a small quantity of iridium was isolated and used on the iridium-tipped gold dip pen nibs of the 1830s.",
  user_id: user.id,
  price: "$ 967",
  category: "Royal")
...
pen = Pen.new(title: 'Oblique',
  description: "First, the thickness of the nib metal changes flex. When the nib alloy has been pressed thick it will result in a hard nib, while thinly pressed nibs are more flexible.",
  user_id: user.id,
  price: "$ 543",
  category: "Original")
